    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <Link href="/" className="text-white font-bold text-xl block mb-3">Teeth Done in Turkey</Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/treatments/veneers-turkey" className="hover:text-white transition-colors">Veneers Turkey</Link></li>
              <li><Link href="/treatments/dental-implants-turkey" className="hover:text-white transition-colors">Dental Implants</Link></li>
              <li><Link href="/treatments/all-on-4-turkey" className="hover:text-white transition-colors">All-on-4</Link></li>
              <li><Link href="/treatments/all-on-6-turkey" className="hover:text-white transition-colors">All-on-6</Link></li>
              <li><Link href="/treatments/full-smile-makeover-turkey" className="hover:text-white transition-colors">Smile Makeover</Link></li>
            </ul>
          </div>
