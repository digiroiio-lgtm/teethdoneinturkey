      ...
      <article className="py-14 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xs text-gray-500 mb-4">
            ...
            <Link href="/guides/turkey-teeth-packages" className="text-[#1e40af] hover:underline">what Turkey dental packages include</Link>{" "}
            for package-specific detail, or{" "}
            <Link href="/finance-options-uk" className="text-[#1e40af] hover:underline">Turkey teeth finance and payment plans</Link>{" "}
            for monthly payment breakdowns.
          </p>
