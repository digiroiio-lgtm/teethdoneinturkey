...
export const metadata: Metadata = {
  title: "Hollywood Smile Cost in Turkey 2024 — From £2,500 | Teeth Done in Turkey",
  description: "How much does a Hollywood Smile cost in Turkey? From £2,500 for 10 porcelain veneers vs £10,000+ in the UK. Full cost breakdown and what's included.",
  openGraph: {
    title: "Hollywood Smile Cost in Turkey 2024 — From £2,500",
    description: "How much does a Hollywood Smile cost in Turkey? From £2,500 for 10 porcelain veneers vs £10,000+ in the UK. Full cost breakdown and what's included.",
    url: "https://www.teethdoneinturkey.co.uk/prices/hollywood-smile-cost",
    siteName: "Teeth Done in Turkey",
    type: "website",
  },
  alternates: { canonical: "https://www.teethdoneinturkey.co.uk/prices/hollywood-smile-cost" },
};

export default function HollywoodSmileCostPage() {
  return (
    <>
      <section className="bg-gradient-to-br from-[#1a6b3c] to-[#0f4a28] text-white py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-green-200 text-sm mb-4">
            ...
            <span>Hollywood Smile Cost</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Hollywood Smile Cost in Turkey</h1>
          <p className="text-xl text-green-100 max-w-3xl mb-6">
            Compare prices for Hollywood Smile in Turkey vs the UK and USA. All-inclusive packages available with accommodation, transfers, and aftercare.
          </p>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <tbody>
                  <tr className="bg-white"><td className="px-6 py-4 font-medium text-[#1a1a1a]">Hollywood Smile 6 teeth</td><td className="px-6 py-4 text-center text-[#1a6b3c] font-bold">£1,500–£1,800</td><td className="px-6 py-4 text-center text-gray-500">£4,800–£7,200</td><td className="px-6 py-4 text-center text-gray-500">$9,000–$15,000</td></tr>
                  <tr className="bg-gray-50"><td className="px-6 py-4 font-medium text-[#1a1a1a]">Hollywood Smile 8 teeth</td><td className="px-6 py-4 text-center text-[#1a6b3c] font-bold">£2,000–£2,400</td><td className="px-6 py-4 text-center text-gray-500">£6,400–£9,600</td><td className="px-6 py-4 text-center text-gray-500">$12,000–$20,000</td></tr>
                  <tr className="bg-white"><td className="px-6 py-4 font-medium text-[#1a1a1a]">Hollywood Smile 10 teeth</td><td className="px-6 py-4 text-center text-[#1a6b3c] font-bold">£2,500–£3,000</td><td className="px-6 py-4 text-center text-gray-500">£8,000–£12,000</td><td className="px-6 py-4 text-center text-gray-500">$15,000–$25,000</td></tr>
                  <tr className="bg-gray-50"><td className="px-6 py-4 font-medium text-[#1a1a1a]">Hollywood Smile 16 teeth</td><td className="px-6 py-4 text-center text-[#1a6b3c] font-bold">£3,500–£4,500</td><td className="px-6 py-4 text-center text-gray-500">£12,800–£19,200</td><td className="px-6 py-4 text-center text-gray-500">$24,000–$40,000</td></tr>
                  <tr className="bg-white"><td className="px-6 py-4 font-medium text-[#1a1a1a]">+ Teeth Whitening add-on</td><td className="px-6 py-4 text-center text-[#1a6b3c] font-bold">£150–£200</td><td className="px-6 py-4 text-center text-gray-500">£400–£600</td><td className="px-6 py-4 text-center text-gray-500">$500–$800</td></tr>
          ...
          <div>
            ...
            <div className="bg-[#1a6b3c]/5 rounded-2xl p-6 border border-[#1a6b3c]/10">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <div className="flex items-center gap-2 text-sm text-gray-700"><span className="text-[#1a6b3c]">✓</span><span>Custom porcelain veneers</span></div>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-700"><span className="text-[#1a6b3c]">✓</span><span>Temporary veneers during lab work</span></div>
                <div className="flex items-center gap-2 text-sm text-gray-700"><span className="text-[#1a6b3c]">✓</span><span>Digital smile design</span></div>
                <div className="flex items-center gap-2 text-sm text-gray-700"><span className="text-[#1a6b3c]">✓</span><span>Final fitting and adjustments</span></div>
                <div className="flex items-center gap-2 text-sm text-gray-700"><span className="text-[#1a6b3c]">✓</span><span>Hotel accommodation (with package)</span></div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <Link href="/treatments/teeth-whitening" className="border border-gray-200 rounded-xl p-4 hover:border-[#1a6b3c] hover:bg-[#1a6b3c]/5 transition-colors"><p className="font-semibold text-[#1a1a1a]">Teeth Whitening Add-on</p></Link>
