...
export const metadata: Metadata = {
  alternates: { canonical: "/blog/full-mouth-dental-implants-turkey-cost" },
...
export default function FullMouthImplantsPage() {
  return (
    <article className="py-16 bg-white">
      <ArticleJsonLd
        id="article-schema-full-mouth-dental-implants-turkey-cost"
        path="/blog/full-mouth-dental-implants-turkey-cost"
        headline="Full Mouth Implants Turkey Cost 2026"
        description="How much does a full mouth of dental implants cost in Turkey? Complete cost breakdown for All-on-4, All-on-6, and full mouth implants for UK patients."
        datePublished="2026-01-01"
        breadcrumbs={[
          { name: "Home", path: "/" },
          { name: "Blog", path: "/blog" },
          { name: "Full Mouth Implants Turkey Cost 2026", path: "/blog/full-mouth-dental-implants-turkey-cost" },
        ]}
      />
