...
const posts = [
  ...
  // Existing posts
  { href: "/blog/veneers-turkey-cost-uk-vs-turkey", title: "Veneers Turkey Cost: UK vs Turkey Price Comparison", excerpt: "A detailed breakdown of what veneers cost in Turkey vs the UK, what's included, and whether you're getting the same quality.", date: "December 2024", tag: "Pricing" },
  { href: "/blog/is-it-safe-to-get-teeth-done-in-turkey", title: "Is It Safe to Get Teeth Done in Turkey? An Honest Guide", excerpt: "The honest answer to the most common question about Turkish dental tourism. Accreditation, safety records, and how to choose wisely.", date: "November 2024", tag: "Safety" },
  ...
  { href: "/blog/best-dental-clinics-turkey", title: "Best Dental Clinics in Turkey: How UK Patients Should Choose", excerpt: "Accreditation, materials, UK-based consultation and aftercare, the questions to ask before you pay a deposit, and the red flags to walk away from.", date: "Updated September 2026", tag: "Clinics" },
  { href: "/blog/turkey-teeth-reviews", title: "Turkey Teeth Reviews: Real Patient Experiences", excerpt: "We compiled real patient experiences from UK patients who've had dental work done in Turkey — the good, the great, and the rare bad.", date: "October 2024", tag: "Reviews" },
