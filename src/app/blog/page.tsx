...
const posts = [
  ...
  // Existing posts
  { href: "/blog/veneers-turkey-cost-uk-vs-turkey", title: "Veneers Turkey Cost: UK vs Turkey Price Comparison 2026", excerpt: "A detailed breakdown of what veneers cost in Turkey vs the UK, what's included, and whether you're getting the same quality.", date: "Updated September 2026", tag: "Pricing" },
  ...
  { href: "/blog/do-turkey-teeth-look-fake", title: "Do Turkey Teeth Look Fake?", excerpt: "Shade, translucency, tooth shape and digital smile design — what actually determines whether the result looks natural, and how to specify it before treatment starts.", date: "Updated September 2026", tag: "Veneers" },
  ...
  { href: "/reviews", title: "Turkey Teeth Reviews: Real UK Patient Experiences", excerpt: "Real reviews from UK patients who had veneers, implants and smile makeovers in Turkey — the process, the results, and what they would do differently.", date: "Updated September 2026", tag: "Reviews" },
  { href: "/travel-to-turkey/dental-holiday-turkey", title: "Dental Holiday Turkey: The Complete UK Patient Guide", excerpt: "Planning your dental trip to Turkey — flights from the UK, hotels near the clinics, what to pack and tips from patients who have already been.", date: "Updated September 2026", tag: "Travel" },
];
