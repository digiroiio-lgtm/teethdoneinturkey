...
export default function SameDayImplantsPage() {
  return (
    <article className="py-16 bg-white">
      <ArticleJsonLd
        id="article-schema-same-day-dental-implants-turkey"
        path="/blog/same-day-dental-implants-turkey"
        headline="Same Day Implants Turkey – UK Guide"
        description="Everything UK patients need to know about same day dental implants in Turkey. How they work, who is suitable, costs, and what to expect."
        datePublished="2026-01-01"
        breadcrumbs={[
          { name: "Home", path: "/" },
          { name: "Blog", path: "/blog" },
          { name: "Same Day Implants Turkey – UK Guide", path: "/blog/same-day-dental-implants-turkey" },
        ]}
      />
