...
export default function DentalHolidayPackagesPage() {
  return (
    <article className="py-16 bg-white">
      <ArticleJsonLd
        id="article-schema-dental-holiday-packages-turkey"
        path="/blog/dental-holiday-packages-turkey"
        headline="Dental Holiday Packages Turkey"
        description="Everything about dental holiday packages in Turkey for UK patients. What's included, how packages work, costs, and how to book your treatment and stay."
        datePublished="2026-01-01"
        breadcrumbs={[
          { name: "Home", path: "/" },
          { name: "Blog", path: "/blog" },
          { name: "Dental Holiday Packages Turkey", path: "/blog/dental-holiday-packages-turkey" },
        ]}
      />
