...
export const metadata: Metadata = {
  ...
  title: { absolute: "Dental Implants Cost: UK vs Turkey 2026" },
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {[
                ...
                { href: "/prices/turkey-teeth-cost", label: "📘 Turkey Teeth Cost Guide", sub: "Full 2026 price guide" },
                ...
                { href: "/monthly-payment", label: "Monthly Payment Plans", sub: "From £125/month (All-on-4)" },
              ].map(item => (
