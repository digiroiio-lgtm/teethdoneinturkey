...
const PAGE_URL = `${SITE_URL}/treatments/all-on-4-turkey`;
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "All-on-4 Turkey", item: PAGE_URL },
  ],
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "All-on-4 Dental Implants Turkey – From £4,500 per Arch",
  description: "All-on-4 dental implants in Turkey from £4,500 per arch. Full arch restoration in 5–7 days. UK price comparison, procedure and how to book.",
  url: PAGE_URL,
  ...
  about: { "@type": "MedicalProcedure", name: "All-on-4 Dental Implants" },
};
    ...
    <>
      ...
      <div className="hero-gradient text-white py-16 px-4 relative overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="mb-3">
            <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Treatments", href: "/treatments" }, { label: "All-on-4" }]} />
          </div>
          ...
          <p className="text-blue-300 mb-2">Compare to £15,000+ in the UK — save over 70%</p>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                { title: "Full Mouth Implant Cost", href: "/blog/full-mouth-implants-uk-vs-turkey", desc: "What All-on-4 costs across both arches, and what the package covers." },
              ].map(item => (
