          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                { title: "Patient Story: Sarah, Manchester", href: "/patient-stories/veneers-turkey-uk-patient", desc: "Sarah saved £14,200 on 20 porcelain veneers. Read her full story." },
              ].map(item => (
