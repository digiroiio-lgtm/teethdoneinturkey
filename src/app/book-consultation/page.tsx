          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-xl">
                ...
                <a href="https://wa.me/905353998999" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-green-600 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              { icon: "💳", title: "Finance Available", desc: "Spread costs from £53/month at 0% APR representative. Soft-search eligibility check, no impact on your score." },
