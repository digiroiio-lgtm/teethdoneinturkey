...
const TITLE = "Best Veneers in Turkey: Types, Costs & How to Choose";
const H1 = "Best Veneers in Turkey: Types, Clinics, Costs & How to Choose";
const DESCRIPTION =
  "E-max vs zirconia vs composite veneers in Turkey: which looks most natural, needs least tooth prep and lasts longest, plus how to choose a clinic.";
