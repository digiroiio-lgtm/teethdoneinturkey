...
const TITLE = "Full Set of Teeth in Turkey: What It Means & Costs";
const H1 = "Full Set of Teeth in Turkey Cost: What Does 'Full Set' Mean and What Does It Cost?";
const DESCRIPTION =
  "What UK patients mean by a ‘full set’ of Turkey teeth, and what each option costs: crowns, veneers, All-on-4, All-on-6 and full mouth implants.";
