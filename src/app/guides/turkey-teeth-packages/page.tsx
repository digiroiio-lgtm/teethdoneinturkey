...
const TITLE = "Turkey Teeth Packages: What’s Included, What It Costs";
const H1 = "Turkey Teeth Packages: What Is Actually Included and What Does It Cost?";
const DESCRIPTION =
  "Package price is not total cost. What Turkey dental packages include, what they leave out, and what to check before you book.";
